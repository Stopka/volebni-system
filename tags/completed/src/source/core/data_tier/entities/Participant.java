...
public class Participant {
    ...
    private String login;       //nepovinný 
    private String passwd;      //nepovinný
    ...
    private boolean completeReg; //údaj nastavovaný po vytvoření.
    ...
    public String toString(){
        return "ID: " + id + ", Jméno: " + firstName + " " + lastName + 
                (completeReg ? ", Login: " + login : ", Nezaregistrovaný"); 
    }
}
